    ...
    <header class="bg-white py-4 2xl:py-7 shadow-xl relative">
      ...
      <div class="container mx-auto flex items-center justify-left px-5">
        ...
        <nav class="hidden lg:block  absolute lg:relative bg-white">
          <ul class="flex flex-col lg:flex-row flex-wrap items-center space-x-0 lg:space-x-6 xl:space-x-10 3xl:space-x-16">
            <!-- Menus before login, Remove the classes from list item below either you are loggedin or not i.e. for only my purpose -->
            <li class="lg:hidden"><a href="javascript:void(0)" class="dark:text-white text-sm lg:text-base 2xl:text-lg text-black focus:outline-none hover:text-primary">Home</a></li>
            <li class="lg:hidden"><a href="javascript:void(0)" class="dark:text-white text-sm lg:text-base 2xl:text-lg text-black focus:outline-none hover:text-primary">About</a></li>
            <li class="lg:hidden"><a href="javascript:void(0)" class="dark:text-white text-sm lg:text-base 2xl:text-lg text-black focus:outline-none hover:text-primary">Services</a></li>
            <li class="lg:hidden"><a href="javascript:void(0)" class="dark:text-white text-sm lg:text-base 2xl:text-lg text-black focus:outline-none hover:text-primary">Testimonials</a></li>
            <li class="lg:hidden"><a href="javascript:void(0)" class="dark:text-white text-sm lg:text-base 2xl:text-lg text-black focus:outline-none hover:text-primary">Contact</a></li>
            <!-- Menus after login --> 
            <li><a href="javascript:void(0)" class="dark:text-white text-sm lg:text-base 2xl:text-lg text-black focus:outline-none hover:text-primary">Dashboard</a></li>
            <li>
              <a href="javascript:void(0)" class="dark:text-white text-sm lg:text-base 2xl:text-lg text-black focus:outline-none hover:text-primary flex items-center dropdown-with-arrow">Jobs
                <svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg" class="arrow-icon ml-2">
                  <path d="M0.816406 1.0376L6.81641 6.58648L12.8164 1.0376" stroke="black" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </a>
            </li>
          </ul>
        ...
        <div class="justify-end flex items-center space-x-2 sm:space-x-5 md:space-x-6 xl:space-x-10 ml-auto">
          <!-- Show this anchor when user is loggedin -->
          <a href="#" class="flex items-center hover:text-primary icon-label">
          ...
          <!-- Show this anchor when user is loggedin -->
          <a href="#" class="relative icon-label">
          ...
          <div class="account-labels">
            ...
            <a href="#" class="flex items-center hover:text-primary text-sm lg:text-base 2xl:text-lg dropdown-with-arrow">
          ...
          <div class="hidden sm:hidden items-center">
            <button class="p-3 xl:p-5 font-semibold text-md 2xl:text-lg bg-primary text-white rounded-sm shadow-sm hover:bg-green duration-500 ease-in-out" @click="showModalSignup = true">For Professionals</button>
          </div>
          ...
          <div class="flex lg:hidden">
            ...
            <button aria-label="open menu" class="text-blackdark:text-white dark:hover:text-gray-300 md:hidden focus:outline-none focus:ring-2 rounded focus:ring-gray-600">
              <svg class="fill-stroke" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M4 6H20" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M10 12H20" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M6 18H20" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
