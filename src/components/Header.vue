  ...
  <div class="dark:bg-gray-900">
    <div>
      <div class="relative">
        ...
        >
          <div
            class="flex items-center space-x-3 text-gray-800 dark:text-white"
          >
            <div>
              <svg
                class="fill-stroke"
        ...
        <!-- For large screens -->
        <div class="dark:bg-gray-900 bg-white px-6 py-2 shadow-xl">
          <div class="container mx-auto flex items-center justify-between">
            <img />
            <ul class="hidden md:flex items-center space-x-10 flex-1">
              <li>
                <a
            ...
            <div class="justify-end flex items-center space-x-4 xl:space-x-8">
              ...
              <div class="hidden lg:flex items-center space-x-4 xl:space-x-8">
                <button
                  class="p-4 font-semibold text-sm bg-primary text-white rounded-md shadow-sm"
                >
                  For Professionals
                </button>
              </div>
