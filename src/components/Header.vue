<template>
  ...
  <div class="wrapper header-wrapper" :class="{'header-scrolled': scrolled}">
    <div class="bg-white py-2 3xl:py-4 shadow-xl relative">
      <!-- If user login add a class "justify-left" else "justify-between" in below container div -->
      <div class="container mx-auto flex items-center justify-between px-5 xl:px-20 2xl:px-28 3xl:px-5">
        ...
        <nav class="inline-block lg:block fixed lg:absolute lg:relative bg-white transition-all" :class="(showHeaderMenus == true)?'showMenu':''">
          <ul class="flex flex-col lg:flex-row flex-wrap lg:items-center space-x-0 lg:space-x-6 xl:space-x-10 3xl:space-x-16">
            ...
            <li class=""><a href="javascript:void(0)" class="px-3 lg:px-0 py-3 border-b border-gray lg:border-0 lg:py-0 block dark:text-white text-sm lg:text-base 3xl:text-lg text-lightBlack focus:outline-none hover:text-primary">Home</a></li>
            <li class=""><a href="javascript:void(0)" class="px-3 lg:px-0 py-3 border-b border-gray lg:border-0 lg:py-0 block dark:text-white text-sm lg:text-base 3xl:text-lg text-lightBlack focus:outline-none hover:text-primary">About</a></li>
            <li class=""><a href="javascript:void(0)" class="px-3 lg:px-0 py-3 border-b border-gray lg:border-0 lg:py-0 block dark:text-white text-sm lg:text-base 3xl:text-lg text-lightBlack focus:outline-none hover:text-primary">Services</a></li>
            <li class=""><a href="javascript:void(0)" class="px-3 lg:px-0 py-3 border-b border-gray lg:border-0 lg:py-0 block dark:text-white text-sm lg:text-base 3xl:text-lg text-lightBlack focus:outline-none hover:text-primary">Testimonials</a></li>
            <li class=""><a href="javascript:void(0)" class="px-3 lg:px-0 py-3 border-b border-gray lg:border-0 lg:py-0 block dark:text-white text-sm lg:text-base 3xl:text-lg text-lightBlack focus:outline-none hover:text-primary">Contact</a></li>            
          </ul>
        </nav>

        <!-- If user login add a class "ml-auto" else remove this class in below div -->
        <div class="justify-end flex items-center space-x-2 sm:space-x-5 md:space-x-6 3xl:space-x-10">
          ...
          <div class="hidden sm:flex items-center">
            <router-link class="professional p-3 3xl:p-5 font-semibold text-md 2xl:text-lg bg-primary text-white rounded-sm shadow-sm hover:bg-green duration-500 ease-in-out" @click="showModalSignup = true" to="/homepro" tag="button">For Professional</router-link>
          </div>
