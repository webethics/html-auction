<template>
  ...
  <div class="wrapper header-wrapper" :class="{'header-scrolled': scrolled}">
    <div class="bg-white py-4 2xl:py-2 shadow-xl relative">
      ...
      <div class="container mx-auto flex items-center justify-left px-5 xl:px-20 2xl:px-28 3xl:px-5">
        ...
        <nav class="inline-block lg:block fixed lg:absolute lg:relative bg-white transition-all" :class="(showHeaderMenus == true)?'showMenu':''">
          <ul class="flex flex-col lg:flex-row flex-wrap lg:items-center space-x-0 lg:space-x-6 xl:space-x-10 3xl:space-x-16">
            <li class="border-b border-gray lg:border-0 ml-0 lg:ml-6 xl:ml-10 3xl:ml-16"><a href="javascript:void(0)" class="px-3 lg:px-0 py-3 lg:py-0 block dark:text-white text-sm lg:text-base 3xl:text-lg text-lightBlack focus:outline-none hover:text-primary">Dashboard</a></li>
            <li class="relative it-has-dropdown border-b border-gray lg:border-0" @click="menuDropdown = !menuDropdown" :class="(menuDropdown == true)?'shown':'closed'">
              <a href="javascript:void(0)" class="px-3 lg:px-0 py-3 lg:py-0 block dark:text-white text-sm lg:text-base 3xl:text-lg text-lightBlack focus:outline-none hover:text-primary flex items-center dropdown-with-arrow">
                Jobs
          ...
          <ul class="justify-end flex items-center space-x-2 sm:space-x-5 md:space-x-6 xl:space-x-10 ">
            ...
            <li class="account-labels relative it-has-dropdown right-dropdown">
              <a href="#" class="flex items-center text-lightBlack hover:text-primary text-sm lg:text-base 2xl:text-lg dropdown-with-arrow">
                <svg class="mr-0 sm:mr-2 profile-icon hidden sm:block" width="33" height="32" viewBox="0 0 33 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span class="mr-2">Mark</span>
                <svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg" class="arrow-icon transition-transform">
                  <path d="M0.816406 1.0376L6.81641 6.58648L12.8164 1.0376" stroke="#313131" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </a>
