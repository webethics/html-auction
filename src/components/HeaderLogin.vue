<template>
  <!-- For large screens -->
  <div class="wrapper">
    <header class="bg-white py-4 2xl:py-2 shadow-xl relative">
      <!-- If user login add a class "justify-left" else "justify-between" in below container div -->
      <div class="container mx-auto flex items-center justify-left px-5">
        ...
        <nav class="inline-block lg:block fixed lg:absolute lg:relative bg-white" :class="(showHeaderMenus == true)?'showMenu':''">
          <ul class="flex flex-col lg:flex-row flex-wrap lg:items-center space-x-0 lg:space-x-6 xl:space-x-10 3xl:space-x-16">
            ...
            <li class="hidden"><a href="javascript:void(0)" class="px-3 lg:px-0 py-3 border-b border-gray lg:border-0 lg:py-0 dark:text-white text-sm lg:text-base 2xl:text-lg text-lightBlack focus:outline-none hover:text-primary">Home</a></li>
            <li class="hidden"><a href="javascript:void(0)" class="px-3 lg:px-0 py-3 border-b border-gray lg:border-0 lg:py-0 dark:text-white text-sm lg:text-base 2xl:text-lg text-lightBlack focus:outline-none hover:text-primary">About</a></li>
            <li class="hidden"><a href="javascript:void(0)" class="px-3 lg:px-0 py-3 border-b border-gray lg:border-0 lg:py-0 dark:text-white text-sm lg:text-base 2xl:text-lg text-lightBlack focus:outline-none hover:text-primary">Services</a></li>
            <li class="hidden"><a href="javascript:void(0)" class="px-3 lg:px-0 py-3 border-b border-gray lg:border-0 lg:py-0 dark:text-white text-sm lg:text-base 2xl:text-lg text-lightBlack focus:outline-none hover:text-primary">Testimonials</a></li>
            <li class="hidden"><a href="javascript:void(0)" class="px-3 lg:px-0 py-3 border-b border-gray lg:border-0 lg:py-0 dark:text-white text-sm lg:text-base 2xl:text-lg text-lightBlack focus:outline-none hover:text-primary">Contact</a></li>
            <!-- Menus after login --> 
            <li><a href="javascript:void(0)" class="px-3 lg:px-0 py-3 border-b border-gray lg:border-0 lg:py-0 block dark:text-white text-sm lg:text-base 2xl:text-lg text-lightBlack focus:outline-none hover:text-primary">Dashboard</a></li>
            <li class="relative it-has-dropdown">
              <a href="javascript:void(0)" class="px-3 lg:px-0 py-3 border-b border-gray lg:border-0 lg:py-0 block dark:text-white text-sm lg:text-base 2xl:text-lg text-lightBlack focus:outline-none hover:text-primary flex items-center dropdown-with-arrow">
                Jobs
                <svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg" class="arrow-icon ml-2 transition-transform">
                  <path d="M0.816406 1.0376L6.81641 6.58648L12.8164 1.0376" stroke="#313131" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </a>
              <span class="absolute bg-white text-sm leading-20 mx-auto shadow-dropdown rounded-sm">
                <ul class="sub-menu">
                  <li class="mb-1"><a href="#" class="hover:text-primary block">Plumber</a></li>
                  <li class="mb-1"><a href="#" class="hover:text-primary block">Contractor</a></li>
                  <li><a href="#" class="hover:text-primary block">Realtor</a></li>
                </ul>    
              </span>
            </li>
          </ul>
        ...
        <div class="ml-auto">
          <ul class="justify-end flex items-center space-x-2 sm:space-x-5 md:space-x-6 xl:space-x-10 ">
            <li>
              <a href="#" class="flex items-center text-lightBlack hover:text-primary icon-label">
            ...
            <li>
              <!-- Show this anchor when user is loggedin -->
              <a href="#" class="relative icon-label block">
              ...
              <li class="account-labels relative it-has-dropdown right-dropdown">
                <a href="#" class="flex items-center text-lightBlack hover:text-primary text-sm lg:text-base 2xl:text-lg dropdown-with-arrow">
                  ...
                  <svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg" class="arrow-icon hidden sm:inline-block transition-transform">
                    <path d="M0.816406 1.0376L6.81641 6.58648L12.8164 1.0376" stroke="#313131" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>
                </a>
                <span class="absolute bg-white text-sm leading-20 mx-auto shadow-dropdown rounded-sm right-dropdown">
                  <ul class="sub-menu">
                    <li class="mb-1"><a href="#" class="hover:text-primary block">My Account</a></li>
                    <li class="mb-1"><router-link to="/job-listing" tag="button" class="hover:text-primary block">My Jobs</router-link></li>
                    <li><a href="#" class="hover:text-primary block">Settings</a></li>
                  </ul>    
                </span>
              </li>
            </ul>
